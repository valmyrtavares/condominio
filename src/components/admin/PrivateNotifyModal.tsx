...
export const PrivateNotifyModal: React.FC<PrivateNotifyModalProps> = ({
  ...
  return (
    <div className="modal-overlay-safe bg-black/75 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      <div className="modal-content-safe relative w-full max-w-lg bg-white border-2 border-amber-400 rounded-3xl p-5 sm:p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 z-10">
