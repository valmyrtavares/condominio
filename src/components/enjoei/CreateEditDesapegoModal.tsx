...
export const CreateEditDesapegoModal: React.FC<CreateEditDesapegoModalProps> = ({
  ...
  const modalContent = (
    <div className="modal-overlay-safe bg-black/75 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      <div className="modal-content-safe relative w-full max-w-2xl bg-white border-2 border-rose-400 rounded-3xl shadow-2xl flex flex-col z-10 animate-in zoom-in-95 duration-200">
